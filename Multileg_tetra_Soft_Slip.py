...
m1 = 0.6 + 0.05 * 3 #Mass of Body [Kg]
#m1 = 0.7 + 1*4  #Mass of Body [Kg]
	...
	while(t<t_f):
			...
			if l - del_AE < del_s:
				if XX[n,6]< 0 and XX[n,7]<0:
					...
					P3 = 1/l* R90 * (P1-P2) * L + P1
					P5 = 1/l* R270 * (P1-P2) * L + P1
					#Sy = np.array([[P3[0],P3[1],P4[0],P4[1],P5[0],P5[1]]])
					Sy = np.array([[P3[0][0],P3[1][0],P4[0][0],P4[1][0],P5[0][0],P5[1][0]]])
					YY = np.append(YY, Sy, axis=0)
					print(n)
					print("Using func3")
...
def main():
	...
	#plt.ylim([0,LimMaxY])
	plt.legend()
	plt.savefig("Tetra_Soft_Slip_T-XZ.png")
	...
	plt.ylim([0,LimMaxY])
	plt.legend()
	plt.savefig("Tetra_Soft_Slip_XZ.png")
	#plt.show()
	...
	#ani.save("tetra_Soft_Slip.gif", writer = 'imagemagick')
	plt.show()
