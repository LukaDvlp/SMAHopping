...
def test_func2(x):
	if (x[0]-x[2])-del_AE < del_s:
		...
		term2 = -(k1*(l0-(x[0]-x[2]))-A*((x[0]-x[2])-del_AE))/M2 + c1/M2*(x[1]-x[3]) +(k1*(l0-(x[0]-x[2]))-A*((x[0]-x[2])-del_AE))/M2 - c1/M2*(x[1]-x[3]) - g +g
		print"term2 = {0}".format(term2)
	else:
		term1 = (k1*(l0-(x[0]-x[2]))-F_s)/M1 - c1/M1*(x[1]-x[3]) - g
		print"term1 = {0}".format(term1)
		print"SMA resistance = {0}".format(x[0]-x[2]-del_AE)
		term2 = -(k1*(l0-(x[0]-x[2]))-F_s)/M2 + c1/M2*(x[1]-x[3]) +(k1*(l0-(x[0]-x[2]))-F_s)/M2 - c1/M2*(x[1]-x[3]) - g +g
		print"term2 = {0}".format(term2)
